...
def deploy():
    ...
    payload = json.dumps({
        "name": sanitize_name("Customer-Support-Agent"),
        "description": """A Customer support agent that can search our knowledge base, Provide a Customer Support related information for banking customer""",
        "definition": {
            "kind": "prompt",
            "model": "gpt-40",
            "instructions": """A Customer support agent that can search our knowledge base, Provide a Customer Support related information for banking customer"""
        }
    }).encode()
